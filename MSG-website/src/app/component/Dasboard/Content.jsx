...
const EditableTable = () => {
  ...
  const handleSave = async (id) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://msg-website-pa8k.onrender.com/api/v1/exhibition/update/${id}`,
        updatedData,
        config
      );
      setData((prevData) =>
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(
        `https://msg-website-pa8k.onrender.com/api/v1/exhibition/remove/${id}`,
        config
      );
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://msg-website-pa8k.onrender.com/api/v1/exhibition/add",
        newData,
        config
      );
