export default function About() {
  return (
    <section className="flex flex-col items-center justify-center w-full bg-primary-darkBlue px-10">
      <div
        className="flex flex-col items-center justify-center w-full bg-cover bg-center bg-no-repeat p-6 rounded-xl z-10 shadow-lg shadow-primary-shadowPurple "
        ...
        <div className="flex flex-row items-start justify-center w-full gap-6">
          ...
          <div className="flex flex-col items-start justify-start w-4/5 gap-6 ">
            <div className="flex flex-col gap-1 mx-4">
              <h4 className="text-xl text-primary-darkBlue uppercase">
                Started
              </h4>
              <p className="text-xl font-bold text-primary-lightRed uppercase">
                February, 1999
              </p>
            </div>
